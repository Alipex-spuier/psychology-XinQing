	...
	<view class="container">
		<view class="ui-all">
			<view class="avatar"  @click="chooseAvatar">
				...
				<text  @click="chooseAvatar">修改头像</text>
			</view>
			<view class="ui-list">
				<text>用户ID</text>
				<text>{{userId}}</text>
			...
			<view class="ui-list">
				<text>用户名</text>
				<input type="text" :placeholder="value" :value="username" @input="bindUsername"
					placeholder-class="place" />
			</view>
			<view class="ui-list">
				<text>年龄</text>
				<input type="text" :placeholder="value" :value="age" @input="bindAge" placeholder-class="place" />
			</view>
			<view class="ui-list">
				<text>职业</text>
				<input type="text" :placeholder="value" :value="work" @input="bindWork" placeholder-class="place" />
			</view>
			<view class="ui-list">
				<text>国家</text>
				<input type="text" :placeholder="value" :value="country" @input="bindCountry"
					placeholder-class="place" />
			</view>
			<view class="ui-list">
				<text>邮箱</text>
...
<script>
	export default {
		created() {
			...
			this.country = user.data.data.country;
			this.age = user.data.data.age;
		},
		data() {
			return {
				value: '请填写',
